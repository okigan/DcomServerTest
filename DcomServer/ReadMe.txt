========================================================================
    ACTIVE TEMPLATE LIBRARY : DcomServer Project Overview
========================================================================

AppWizard has created this DcomServer project for you to use as the starting point for
...
DcomServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (DcomServer.h)
        GUID definitions                                (DcomServer_i.c)
        A type library                                  (DcomServer.tlb)
        Marshaling code                                 (DcomServer_p.c and dlldata.c)

DcomServer.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in DcomServer.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named DcomServer.pch and a precompiled types file named StdAfx.obj.
...
DcomServerps.vcxproj
	...
	dlldata.c, DcomServer_i.c and DcomServer_p.c which are required
	to build the proxy/stub DLL.

DcomServerps.vcxproj.filters
